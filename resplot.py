...
df1 = pandas.read_csv(in_dir + "1.tsv", encoding='utf8', names=names2, sep='\t')
df2 = pandas.read_csv(in_dir + "2.tsv", encoding='utf8', names=names, sep='\t')
df3 = pandas.read_csv(in_dir + "3.tsv", encoding='utf8', names=names, sep='\t')
df4 = pandas.read_csv(in_dir + "4.tsv", encoding='utf8', names=names, sep='\t')
df5 = pandas.read_csv(in_dir + "5.tsv", encoding='utf8', names=names, sep='\t')
df6 = pandas.read_csv(in_dir + "6.tsv", encoding='utf8', names=names, sep='\t')
df7 = pandas.read_csv(in_dir + "7.tsv", encoding='utf8', names=names, sep='\t')
df8 = pandas.read_csv(in_dir + "8.tsv", encoding='utf8', names=names, sep='\t')
df9 = pandas.read_csv(in_dir + "9.tsv", encoding='utf8', names=names, sep='\t')
df10 = pandas.read_csv(in_dir + "10.tsv", encoding='utf8', names=names, sep='\t')
df11 = pandas.read_csv(in_dir + "11.tsv", encoding='utf8', names=names, sep='\t')
df12 = pandas.read_csv(in_dir + "12.tsv", encoding='utf8', names=names, sep='\t')
df13 = pandas.read_csv(in_dir + "13.tsv", encoding='utf8', names=names, sep='\t')
df14 = pandas.read_csv(in_dir + "14.tsv", encoding='utf8', names=names, sep='\t')
df15 = pandas.read_csv(in_dir + "15.tsv", encoding='utf8', names=names, sep='\t')
df16 = pandas.read_csv(in_dir + "16.tsv", encoding='utf8', names=names, sep='\t')
df17 = pandas.read_csv(in_dir + "17.tsv", encoding='utf8', names=names, sep='\t')
df18 = pandas.read_csv(in_dir + "18.tsv", encoding='utf8', names=names2, sep='\t')
df19 = pandas.read_csv(in_dir + "19.tsv", encoding='utf8', names=names2, sep='\t')
